                                            ...
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" id="validationCustom01"  placeholder="Enter a Name Room.." required name="name">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" id="validationCustom01"  placeholder="Enter a Describe.." required name="describe">
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input class="form-control" id="validationCustom03" placeholder="Choose a safe one.." required name="size">
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" id="validationCustom08"  placeholder="http://image_1.com|http://image_2.com" required name="video">
                                                            <div class="invalid-feedback">
                                                                Please enter a url.
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" id="validationCustom06" placeholder="$21.60" required name="price">
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" id="validationCustom07"  placeholder="sea" required name="view">
                                                            <div class="invalid-feedback">
                                                                Please enter a url.
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" id="validationCustom08"  placeholder="http://image_1.com|http://image_2.com" required name="image">
                                                            <div class="invalid-feedback">
                                                                Please enter a url.
                                                            </div>
                                                        </div>
