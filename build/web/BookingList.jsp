                                        ...
                                        <table class="table table-list i-table style-1 mb-4 border-0" id="guestTable-all3">
                                            ...
                                            <c:forEach items="${list}" var="r" begin="${(page-1) * pagesize}" end="${page * pagesize -1}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <h5 class="fs-15 font-w500 text-nowrap">${r.bookDate}</h5>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <h5 class="fs-15 font-w500 text-nowrap">${r.inDate}</h5>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <h5 class="fs-15 font-w500 text-nowrap">${r.outDate}</h5>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <h5 class="fs-15 font-w500 text-nowrap">${r.roomName}</h5>
                                                            <span class="fs-14 font-w400 text-nowrap">Room number ${r.roomId}</span>
                                                        </div>
                                                    </td>
                                                    <td><span class=" badge badge-xl light ${r.statusId == 2 ? "badge-danger" : r.statusId == 1 ? "badge-warning" : r.statusId == 3 ? "badge-success" :"badge-default"} badge-sm" id="status">
                                                            ${r.statusId == 2 ? "Occupied" : r.statusId == 1 ? "Booked" : r.statusId == 3 ? "Completed" : "Cancel"}</span> </td>
                                                    <td>
                                            ...
                                            <ul class="pagination pagination-gutter pagination-primary style-1">
                                                <c:if test="${page > 1}">
                                                    <li class="page-item page-indicator job-search-page">
                                                        <a class="page-link" href='listbooking?page=<fmt:formatNumber value="1" type="number"/>'><<</a>
                                                    </li>
                                                    <li class="page-item page-indicator job-search-page">
                                                        <a class="page-link" href='listbooking?page=<fmt:formatNumber value="${page - 1}" type="number"/>'><</a>
                                                    </li>
                                                </c:if>
                                                <c:if test="${page == 1}">
                                                    <li class="page-item page-indicator job-search-page">
                                                ...
                                                <li class="page-item active" ><p class="page-link">${page}</p></li>
                                                    ...
                                                    <li class="page-item page-indicator job-search-page"><a class="page-link" href='listbooking?page=<fmt:formatNumber value="${page + 1}" type="number"/>'>></a>
                                                    </li>
                                                    <li class="page-item page-indicator job-search-page">
                                                        <a class="page-link" href='listbooking?page=<fmt:formatNumber value="${Math.ceil(list.size() / pagesize)}" type="number"/>'>>></a>
                                                    </li>
                                                </c:if>
