                                            ...
                                            <ul class="pagination pagination-gutter pagination-primary style-1">
                                                <c:if test="${page > 1}">
                                                    <li class="page-item page-indicator job-search-page">
                                                        <a class="page-link" href='payment?page=<fmt:formatNumber value="1" type="number"/>'><<</a>
                                                    </li>
                                                    <li class="page-item page-indicator job-search-page">
                                                        <a class="page-link" href='payment?page=<fmt:formatNumber value="${page - 1}" type="number"/>'><</a>
                                                    </li>
                                                </c:if>
                                                <c:if test="${page == 1}">
                                                    <li class="page-item page-indicator job-search-page">
                                                ...
                                                <li class="page-item active" ><p class="page-link">${page}</p></li>
                                                    ...
                                                    <li class="page-item page-indicator job-search-page"><a class="page-link" href='payment?page=<fmt:formatNumber value="${page + 1}" type="number"/>'>></a>
                                                    </li>
                                                    <li class="page-item page-indicator job-search-page">
                                                        <a class="page-link" href='payment?page=<fmt:formatNumber value="${Math.ceil(list.size() / pagesize)}" type="number"/>'>>></a>
                                                    </li>
                                                </c:if>
