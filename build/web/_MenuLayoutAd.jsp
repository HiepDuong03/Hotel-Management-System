<%-- 
    Document   : MenuAd
    Created on : May 15, 2023, 9:30:15 PM
    Author     : Admin
--%>
...
<div class="deznav">
    <div class="deznav-scroll">
        ...
        <ul class="metismenu" id="menu">
            ...
            <li><a href="BookingActivity.jsp" >
                    <i class="bi bi-person-fill"></i>
                    <span class="nav-text">Booking Activity</span>
                </a>

            </li>

            <li><a  href="RoomsAd.jsp" aria-expanded="false">
                    <i class="bi bi-door-closed"></i>
                    <span class="nav-text">Rooms</span>
                </a>

            </li>
            <li><a  href="PaymentHistory.jsp" aria-expanded="false">
