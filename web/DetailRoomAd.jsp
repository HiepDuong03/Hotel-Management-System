            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Edit Check Out Date</h5>
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-group">
                                ...
                                <input type="date" id="checkOutDate" class="form-control" value="${detail2.inDate}" name="newdate">
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        ...
                        %>
                        <button type="button" class="btn btn-primary save-btn" onclick="window.location.href='editbooking?rid=${r.roomId}'">Save</button> 
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                                        ...
                                        <div class="profile-media">
                                            <div class="d-flex align-items-center align-items-sm-start">
                                                ...
                                                <div class="media-content">
                                                    <h3 class="fs-21">${user.name}</h3>
                                                    <p class="fs-16 mb-0">Identity Card: ${user.cmnd}</p>
                                                </div>
                                            </div>	
                            ...
                            <div class="card h-auto">
                                <div class="card-header border-0 pb-0">
                                    <h4 class="fs-24 font-w500">${detail1.roomName}</h4>
                                    <div class="dropdown dropstart">
                                        <a href="javascript:void(0);" class="btn-link" data-bs-toggle="dropdown" aria-expanded="false">
                                            <svg class="prof-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M11 12C11 12.5523 11.4477 13 12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12Z" stroke="#262626" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                ...
                                <div class="card-body pt-0">
                                    <div class="d-flex align-items-center justify-content-between mb-4 ">
                                        <p class="m-0">Room number: ${detail1.roomId}</p>
                                        <div class="dropdown"> 
                                            <a href="javascript:void(0);" class="btn  btn-sm" style="background-color: #FFC107" id="dropdownButton">BOOKED</a>
<!--                                            <ul class="dropdown-menu" aria-labelledby="dropdownButton">
                                                <li><a class="dropdown-item" onclick="changeButtonTextAndFilter('AVAILABLE', '#28A745')" href="#">AVAILABLE</a></li>
                                                <li><a class="dropdown-item" onclick="changeButtonTextAndFilter('CANCEL', 'black')" href="#">CANCEL</a></li>
                                                <li><a class="dropdown-item" onclick="changeButtonTextAndFilter('WARMING', 'gray')" href="#">WARMING</a></li>
                                                <li><a class="dropdown-item" onclick="changeButtonTextAndFilter('OCCUPIED', 'red')" href="#">OCCUPIED</a></li>
                                                <li><a class="dropdown-item" onclick="changeButtonTextAndFilter('BOOKED', '#FFC107')" href="#">BOOKED</a></li>
                                            </ul>-->
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <div class="ms-4">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <h5 class="fs-15 mb-4 ms-3">${detail1.roomBed} Bed</h5>
                                            </div>
                                        </div>
                                        <div class="ms-4">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <h5 class="fs-15 mb-4 ms-3">${detail1.roomMax} Person</h5>
                                            </div>
                                        </div>
                                        <div class="ms-4">
                                            <p class="fs-12">Room Price</p>
                                            <div class="d-flex">
                                                <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M12.0837 9.76416C12.9036 9.12303 13.5029 8.24201 13.7982 7.24397C14.0935 6.24592 14.07 5.18061 13.7309 4.19658C13.3918 3.21255 12.7541 2.35886 11.9067 1.75455C11.0593 1.15024 10.0445 0.825439 9.00366 0.825439C7.96285 0.825439 6.94798 1.15024 6.10058 1.75455C5.25318 2.35886 4.61548 3.21255 4.27642 4.19658C3.93735 5.18061 3.91382 6.24592 4.2091 7.24397C4.50439 8.24201 5.10377 9.12303 5.92366 9.76416C4.37463 10.3805 3.04588 11.447 2.10888 12.8259C1.17188 14.2048 0.669646 15.8329 0.666992 17.5V18.3333C0.666992 18.5543 0.75479 18.7663 0.91107 18.9226C1.06735 19.0789 1.27931 19.1667 1.50033 19.1667H16.5003C16.7213 19.1667 16.9333 19.0789 17.0896 18.9226C17.2459 18.7663 17.3337 18.5543 17.3337 18.3333V17.5C17.3315 15.8336 16.8303 14.2061 15.8945 12.8273C14.9588 11.4485 13.6314 10.3816 12.0837 9.76416ZM5.66699 5.83333C5.66699 5.17406 5.86249 4.5296 6.22876 3.98143C6.59503 3.43327 7.11563 3.00603 7.72471 2.75374C8.3338 2.50145 9.00402 2.43543 9.65063 2.56405C10.2972 2.69267 10.8912 3.01014 11.3573 3.47631C11.8235 3.94249 12.141 4.53643 12.2696 5.18303C12.3982 5.82964 12.3322 6.49986 12.0799 7.10894C11.8276 7.71803 11.4004 8.23863 10.8522 8.6049C10.3041 8.97117 9.6596 9.16667 9.00033 9.16667C8.11627 9.16667 7.26842 8.81548 6.6433 8.19035C6.01818 7.56523 5.66699 6.71739 5.66699 5.83333ZM2.33366 17.5C2.33366 15.7319 3.03604 14.0362 4.28628 12.786C5.53652 11.5357 7.23222 10.8333 9.00033 10.8333C10.7684 10.8333 12.4641 11.5357 13.7144 12.786C14.9646 14.0362 15.667 15.7319 15.667 17.5H2.33366Z" fill="#F66F4D"/>
                                                </svg>
                                                <h5 class="fs-15 mb-4 ms-3">${detail1.roomPrice}$</h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <div class="ms-4">
                                            <p class="fs-12">Room Size</p>
                                            <div class="d-flex">
                                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M17.2917 9.37501H2.70833C2.25 9.37501 1.875 9.00001 1.875 8.54168V2.54168C1.875 1.25001 2.91667 0.208344 4.20833 0.208344H15.7917C17.0833 0.208344 18.125 1.25001 18.125 2.54168V8.54168C18.125 9.00001 17.75 9.37501 17.2917 9.37501ZM3.5 7.75001H16.4583V2.54168C16.4583 2.16668 16.1667 1.83334 15.75 1.83334H4.20833C3.83333 1.83334 3.5 2.12501 3.5 2.54168V7.75001Z" fill="#F66F4D"/>
                                                <path d="M18.958 17.375H1.04134C0.583008 17.375 0.208008 17 0.208008 16.5417V8.54168C0.208008 8.08334 0.583008 7.70834 1.04134 7.70834H18.9997C19.458 7.70834 19.833 8.08334 19.833 8.54168V16.5834C19.7913 17 19.4163 17.375 18.958 17.375ZM1.83301 15.75H18.1663V9.37501H1.83301V15.75Z" fill="#F66F4D"/>
                                                ...
                                                <h5 class="fs-15 mb-4 ms-3">${detail1.roomSize} m2</h5>
                                            </div>
                                        </div>
                                        <div class="ms-4">
                                            <p class="fs-12">Room View</p>
                                            <div class="d-flex">
                                                <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                
5.86249 4.5296 6.22876 3.98143C6.59503 3.43327 7.11563 3.00603 7.72471 2.75374C8.3338 2.50145 9.00402 2.43543 9.65063 2.56405C10.2972 2.69267 10.8912 3.01014 11.3573 3.47631C11.8235 3.94249 12.141 4.53643 12.2696 5.18303C12.3982 5.82964 12.3322 6.49986 12.0799 7.10894C11.8276 7.71803 11.4004 8.23863 10.8522 8.6049C10.3041 8.97117 9.6596 9.16667 9.00033 9.16667C8.11627 9.16667 7.26842 8.81548 6.6433 8.19035C6.01818 7.56523 5.66699 6.71739 5.66699 5.83333ZM2.33366 17.5C2.33366 15.7319 3.03604 14.0362 4.28628 12.786C5.53652 11.5357 7.23222 10.8333 9.00033 10.8333C10.7684 10.8333 12.4641 11.5357 13.7144 12.786C14.9646 14.0362 15.667 15.7319 15.667 17.5H2.33366Z" fill="#F66F4D"/>
                                                </svg>
                                                <h5 class="fs-15 mb-4 ms-3">${detail1.roomStar}<i class="fa-solid fa-star"></i></h5>
                                            </div>
                                        </div>
                                    </div>
                                    <c:if test="${status != \"3\"}">
                                        <div class="ms-4">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <h5 class="fs-15 mb-4 ms-3">${detail2.bookDate}</h5>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <div class="ms-4">
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <h5 class="fs-15 mb-4 ms-3">${detail2.inDate}</h5>
                                                </div>
                                            </div>
                                            <div class="ms-4">
                                                <p>Date Check Out</p>
                                                <div class="d-flex">
                                                    ...
                                                    <h5 class="fs-15 mb-4 ms-3">${detail2.outDate}</h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <div class="ms-4"></div>
                                            <div class="ms-4"><button class="btn btn-link edit-btn">Edit date</button></div>
                                        </div>
                                    </c:if>     
                                </div>
                            </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="guest-bx" >
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <h4 class="mb-0 mt-1 fs-18 font-w500 text-nowrap"><a class="text-black" href="javascript:void(0);" >${p.productName}</a></h4>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td><div class="quantity-container">
                                                                    <div class="quantity">
                                                                        ...
                                                                        <input class="input-quantity" type="text" value="0" readonly>
                                                            ...
                                                            <td>
                                                                <div>
                                                                    <span class="fs-15 font-w500 text-nowrap"  id="price">${p.salePrice}$</span>
                                                                </div>
                                                            </td>
                                                            <td>
        ...
        <script>
            ...
            // Thiết lập giá và số lượng mặc định
            let price = 0;
            let quantity = 1;
            ...
            function calculatePrice(quantity) {
                // Thay đổi cách tính giá của bạn tại đây
                return quantity * 10; // Ví dụ: giá = số lượng * 10
            }
        ...
        <script>
            ...
            checkOutDateInput.setAttribute('min', currentDate);
...
//                const checkOutDateInput = document.getElementById('checkOutDate');
//                const newCheckOutDate = checkOutDateInput.value;
//                const checkOutDateLabel = document.querySelector('.hello');
//                const formattedDate = new Date(newCheckOutDate).toLocaleDateString('vi-VI', {
//                    day: '2-digit',
//                    month: '2-digit',
//                    year: 'numeric'
//                });
//                checkOutDateLabel.textContent = formattedDate;
//
