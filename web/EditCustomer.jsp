                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-validation">
                                        <form action="editcustomer?uid=<%=request.getParameter("uid")%>" method="post" class="needs-validation" novalidate >
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" id="validationCustom01" value="<%=u.getUsername()%>" placeholder="Enter a Name Room.." required name="username"  readonly="true">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" id="validationCustom01" value="<%=u.getName()%>" placeholder="Enter a Name Room.." required name="name">
                                                            <div class="invalid-feedback">
                                                                Please enter a Name Room
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" id="validationCustom01" value="<%=u.getSdt()%>" placeholder="Enter a Name Room.." required name="phone">
                                                            <div class="invalid-feedback">
                                                                Please enter a Name Room
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" id="validationCustom01" value="<%=u.getPassword()%>" placeholder="Enter a Name Room.." required name="pass">
                                                            <div class="invalid-feedback">
                                                                Please enter a Name Room
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="mb-3 row">
                                                        <label class="col-lg-4 col-form-label" for="validationCustom01">Identify Card
                                                            <span class="text-danger">*</span>
                                                        </label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" id="validationCustom01" value="<%=u.getCmnd()%>" placeholder="Enter a Name Room.." required name="cmnd">
                                                            <div class="invalid-feedback">
                                                                Please enter a Name Room
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" id="validationCustom01" value="<%=u.getEmail()%>" placeholder="Enter a Name Room.." required name="email">
                                                            <div class="invalid-feedback">
                                                                Please enter a Name Room
                                                            </div>
                                                        </div>
