...
<html lang="en">
    ...
    <head>
        ...
        <!-- FAVICONS ICON -->
        <link rel="shortcut icon" type="Admin/image/png" href="images/favicon.png" />
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-validation">
                                        <form action="editroom?rid=<%=request.getParameter("rid")%>" method="post" class="needs-validation" novalidate >
                                            <div class="row">
                                                <div class="col-xl-6">
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" id="validationCustom01" value="<%=r.getRoomName()%>" placeholder="Enter a Name Room.." required name="name">
                                                    ...
                                                    <div class="mb-3 row">
                                                        <label class="col-lg-4 col-form-label" for="validationCustom02">Room Describe<span
                                                                class="text-danger">*</span>
                                                        </label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" id="validationCustom01" value="<%=r.getRoomDescrip()%>" placeholder="Enter a Describe.." required name="describe">
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <select class="default-select wide form-control" id="validationCustom02" name="bed">
                                                                <option  data-display="Select">Please select</option>
                                                                <option value="1" <%= (r.getRoomBed() == 1) ? "selected" : ""%>>1 </option>
                                                                <option value="2" <%= (r.getRoomBed() == 2) ? "selected" : ""%>>2 </option>
                                                                <option value="3" <%= (r.getRoomBed() == 3) ? "selected" : ""%>>3 </option>
                                                                <option value="4" <%= (r.getRoomBed() == 4) ? "selected" : ""%>>4 </option>
                                                                <option value="5" <%= (r.getRoomBed() == 5) ? "selected" : ""%>>5 </option>
                                                                <option value="6" <%= (r.getRoomBed() == 6) ? "selected" : ""%>>6 </option>
                                                            </select>
                                                            <div class="invalid-feedback">
                                                                Please select a one.
                                                            </div>
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input class="form-control" id="validationCustom03" value="<%=r.getRoomSize()%>" placeholder="Choose a safe one.." required name="size">
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <select class="default-select wide form-control" id="validationCustom04" name="max">
                                                                <option  data-display="Select">Please select</option>
                                                                <option value="1" <%= (r.getRoomMax() == 1) ? "selected" : ""%>>1 </option>
                                                                <option value="2" <%= (r.getRoomMax() == 2) ? "selected" : ""%>>2 </option>
                                                                <option value="3" <%= (r.getRoomMax() == 3) ? "selected" : ""%>>3 </option>
                                                                <option value="4" <%= (r.getRoomMax() == 4) ? "selected" : ""%>>4 </option>
                                                                <option value="5" <%= (r.getRoomMax() == 5) ? "selected" : ""%>>5 </option>
                                                                <option value="6" <%= (r.getRoomMax() == 6) ? "selected" : ""%>>6 </option>
                                                            </select>
                                                            <div class="invalid-feedback">
                                                                Please select a one.
                                                            </div>
                                                    ...
                                                    <div class="mb-3 row">
                                                        <label class="col-lg-4 col-form-label" for="validationCustom08">Room video
                                                            <span class="text-danger">*</span>
                                                        </label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" id="validationCustom08" value="<%=r.getRoomVideo()%>" placeholder="http://image_1.com|http://image_2.com" required name="video">
                                                            <div class="invalid-feedback">
                                                                Please enter a url.
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <select class="default-select wide form-control" id="validationCustom05" name="star">
                                                                <option  data-display="Select">Please select</option>
                                                                <option value="1" <%= (r.getRoomStar() == 1) ? "selected" : ""%>>1 </option>
                                                                <option value="2" <%= (r.getRoomStar() == 2) ? "selected" : ""%>>2 </option>
                                                                <option value="3" <%= (r.getRoomStar() == 3) ? "selected" : ""%>>3 </option>
                                                                <option value="4" <%= (r.getRoomStar() == 4) ? "selected" : ""%>>4 </option>
                                                                <option value="5" <%= (r.getRoomStar() == 5) ? "selected" : ""%>>5 </option>
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" value="<%=r.getRoomPrice()%>" id="validationCustom06" placeholder="$21.60" required name="price">
                                                            <div class="invalid-feedback">
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" value="<%=r.getRoomView()%>" id="validationCustom07"  placeholder="sea" required name="view">
                                                            <div class="invalid-feedback">
                                                                Please enter a url.
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <select class="default-select wide form-control" id="validationCustom08" name="cate">
                                                                <option  data-display="Select">Please select</option>
                                                                <option value="1" <%= (r.getCateId() == 1) ? "selected" : ""%>>Family Room</option>
                                                                <option value="2" <%= (r.getCateId() == 2) ? "selected" : ""%>>Deluxe Room</option>
                                                                <option value="3" <%= (r.getCateId() == 3) ? "selected" : ""%>>Classic Room</option>
                                                                <option value="4" <%= (r.getCateId() == 4) ? "selected" : ""%>>Superior Room</option>
                                                                <option value="5" <%= (r.getCateId() == 5) ? "selected" : ""%>>Luxury Room</option>
                                                                <option value="6" <%= (r.getCateId() == 6) ? "selected" : ""%>>Suite</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" value="<%=r.getRoomImg()%>" id="validationCustom08"  placeholder="http://image_1.com|http://image_2.com" required name="image">
                                                            <div class="invalid-feedback">
                                                                Please enter a url.
                                                            </div>
                                                        </div>
