                                        ...
                                        <table class="table table-list i-table style-1 mb-4 border-0" id="guestTable-all3">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="padding-left: 4%;">Service</th>
                                                    <th>Date Order</th>
                                                    <th>Quantity</th>
                                                    <th>Price</th>
                                                    <th>Total Payment</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr >
                                                        ...
                                                        <div class="media-bx d-flex py-3  ">
                                                            ...
                                                            <div class="item d-flex" >
                                                               <div class="image-container">
                                                                ...
                                                                <h4 class="mb-0 mt-5 fs-15 font-w500 text-nowrap text-nowrap"><a class="text-black" href="page-error-404.html">Tiger</a></h4>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    <div>
                                                            <h5 class="fs-15 font-w500 text-nowrap">16/7/2002</h5>
                                                            <span>8:00 PM</span>>
                                                        ...
                                                        <td><div class="quantity-container">
                                                                <h5 class="fs-15 font-w500 text-nowrap"  style="margin-left: 20%;">1</h5>
                                                    ...
                                                    <td>
                                                        <div>
                                                            <h5 class="fs-15 font-w500 text-nowrap">0.5$</h5>
                                                          
                                                        </div>
                                                    </td>
                                                    <td><a href="javascript:void(0);" class="btn-link text-nowrap p-4 " style="margin-left: 10%;">170$</a></td>
