									...
									<div class="main-grid">
										<div class="grid-info">
											<div class="popular-rooms">
												...
												<img src="Admin/images/roomgrid-img/pic-14.jpg" alt="image">
												<div class="content">
													<span class="badge badge-primary">BOOKED</span>
													<h3 class="font-w500 text-white pt-3 pb-2 m-0"><a href="CustomerDetail.jsp">Marcella Court</a></h3>
													<span class="font-w400 text-white">#R-001235</span>
												</div>
											</div>
											<div class="review-area">
												<div class="star-rate">
													<h4 class="mb-0 font-w500">4.5</h4>
													<ul>
											...
											<ul class="feature-list">
												<li>Floor <span>N-24</span></li>
												<li>Bed Type <span>Family Bed</span></li>
											</ul>
										</div>
									</div>
								</div>
