...
<div class="deznav">
    <div class="deznav-scroll">
        <div class=" dropdown header-bx"> 
            <a class="nav-link header-profile2 position-relative" href="javascript:void(0);"  role="button" data-bs-toggle="dropdown">
                <div class="header-img position-relative">
                    <img src="https://f99design.com/wp-content/uploads/2020/07/thiet-ke-logo-khach-san-bia.jpg" alt="header-img">
                        ...
                        <div class="header-edit position-absolute">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3.02526 12.5567L7.44727 16.9762L16.2481 8.17043L11.8261 3.75092L3.02526 12.5567Z" fill="#2D3134"/>
                                <path d="M19.6341 3.01762L16.9827 0.366211C16.7401 0.123594 16.4227 0.00160156 16.1051 0H16.0919C15.7743 0.00160156 15.4573 0.123594 15.2153 0.366211L13.4453 2.13383L17.8665 6.55262L19.6342 4.785C19.8768 4.54238 19.9988 4.22539 20.0004 3.90781V3.89461C19.9987 3.57719 19.8767 3.2602 19.6341 3.01762Z" fill="#2D3134"/>
                                <path d="M0 20L5.745 18.6738L1.32379 14.255L0 20Z" fill="#2D3134"/>
                            </svg>
                        </div>
                </div>
                <div class="header-content">
                    <h2 class="font-w500">Sunray</h2>
                    <span class="font-w400">anhkd2002@mail.com</span>
                </div>
            </a> 
        </div>
        <ul class="metismenu" id="menu">
            ...
            <li><a href="payment" >
                    <i class="bi bi-person-fill"></i>
                    <span class="nav-text">Completed Payment</span>
                </a>

            </li>
            <li><a href="listbooking" >
                    <i class="bi bi-person-fill"></i>
                    <span class="nav-text">Booking List</span>
                </a>

            </li>
            <li><a href="listroomad" aria-expanded="false">
